...
mixin HomeAnimation<T extends StatefulWidget>
  ...
  void didChangeDependencies() {
    ...
    configOpacityAnimation =
        Tween<double>(begin: 0, end: 1).animate(controller);

    listOpacityAnimation = Tween<double>(begin: 1, end: 0).animate(controller);

    cardAnimation =
        Tween<double>(begin: 0, end: MediaQuery.of(context).size.height * 0.7)
            .animate(controller);
  }
